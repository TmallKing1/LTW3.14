...
execute if score $state mem matches 2 run function ltw:state/2/tick2
...
# 格式化倒计时
scoreboard players operation $countdown_fast_second mem = $countdown_fast mem
scoreboard players operation $countdown_fast_second mem /= #10 mem
scoreboard players operation $countdown_fast_100ms mem = $countdown_fast mem
scoreboard players operation $countdown_fast_100ms mem %= #10 mem