...
# 根据品质生成不同的物品
# 白色：10x
execute if score #quality mem matches ..10 run function item:bonus_item/gameparty/reverse/white
# 蓝色：4x
execute if score #quality mem matches 11.. run function item:bonus_item/gameparty/reverse/green
