...
execute unless data entity @s EnderItems[{Count: 1b, Slot: 10b, tag: {armor_trim_set: 1b}}] run data modify storage item:armor ChangeType set value 10
execute unless data entity @s EnderItems[{Count: 1b, Slot: 11b, tag: {armor_trim_set: 1b}}] run data modify storage item:armor ChangeType set value 11
execute unless data entity @s EnderItems[{Count: 1b, Slot: 12b, tag: {armor_trim_set: 1b}}] run data modify storage item:armor ChangeType set value 12
execute unless data entity @s EnderItems[{Count: 1b, Slot: 13b, tag: {armor_trim_set: 1b}}] run data modify storage item:armor ChangeType set value 13
execute unless data entity @s EnderItems[{Count: 1b, Slot: 14b, tag: {armor_trim_set: 1b}}] run data modify storage item:armor ChangeType set value 14
execute unless data entity @s EnderItems[{Count: 1b, Slot: 15b, tag: {armor_trim_set: 1b}}] run data modify storage item:armor ChangeType set value 15
execute unless data storage item:armor {ChangeType: -1} run function item:armor_trim/enderchest/switches/type12/change with storage item:armor
