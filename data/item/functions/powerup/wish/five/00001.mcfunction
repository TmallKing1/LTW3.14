...
execute if score @s powerup_00001 matches 0 run tellraw @s ["",{"text": ">> ","color": "green","bold": true},{"text": "你获得了一个新物品！","color": "green"}]
execute if score @s powerup_00001 matches 1..4 run tellraw @s ["",{"text": ">> ","color": "green","bold": true},{"text": "你的物品等级增加了！返还 1 个魔法符咒！","color": "green"}]
execute if score @s powerup_00001 matches 1..4 run scoreboard players add @s primogem 64
execute if score @s powerup_00001 matches 5 run tellraw @s ["",{"text": ">> ","color": "green","bold": true},{"text": "你的物品已到满级，返还 5 个魔法符咒！","color": "green"}]
execute if score @s powerup_00001 matches 5 run scoreboard players add @s primogem 320
