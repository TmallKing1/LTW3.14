...
execute if score @s powerup_00015 matches 0 run summon marker ~ ~ ~ {Tags:["wish_marker"],CustomName:'{"text": "[新]「JK137 的头」","color": "gold"}'}
execute unless score @s powerup_00015 matches 0 run summon marker ~ ~ ~ {Tags:["wish_marker"],CustomName:'{"text": "「JK137 的头」","color": "gold"}'}
execute if score @s powerup_00015 matches 1..4 run scoreboard players add @s primogem_temp 1
execute if score @s powerup_00015 matches 5 run scoreboard players add @s primogem_temp 5
