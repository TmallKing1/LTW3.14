# 给予魔法符咒
summon item ~ ~ ~ {Item: {id: "shaper_armor_trim_smithing_template", Count: 1b, tag: {display: {Name: '{"text":"魔法符咒","color":"light_purple","italic": false}'}, stats_item: 1b, Enchantments: [{id: "infinity", lvl: 1}], HideFlags: 33, CustomModelData: 14320001}}, Tags: ["score_item", "new_stats"], PickupDelay: 0}
