# 钻石质盔甲纹饰 (1d)
scoreboard players set $trim_material_num mem 7
...
tellraw @s[tag=canbuy] ["",{"text":">> ","color":"green","bold":true},"你购买了 ",{"text":"钻石质盔甲纹饰","color":"green"}]
execute as @s[tag=canbuy] run tellraw @a[tag=!canbuy] ["",{"text":">> ","color":"green","bold":true},{"selector": "@s","color":"green"}," 购买了 ",{"text":"钻石质盔甲纹饰","color":"green"}]
scoreboard players set $trim_material_num mem 7
