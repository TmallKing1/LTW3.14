...
tellraw @s[scores={shop_particle=8,green=..19}] ["",{"text":">> ","color":"red","bold":true},{"text":"你没有足够的绿宝石来购买这个装饰!","color":"red"}]
tag @s[scores={shop_particle=8,green=20..}] add canbuy
tellraw @s[scores={shop_particle=9..}] ["",{"text":">> ","color":"green","bold":true},"当前装饰已切换为 ",{"text":"牛 B 的攻击","color":"green"}]

tellraw @s[tag=canbuy] ["",{"text":">> ","color":"green","bold":true},"你购买了 ",{"text":"装饰: 牛 B 的攻击","color":"green"}]
execute as @s[tag=canbuy] run tellraw @a[tag=!canbuy] ["",{"text":">> ","color":"green","bold":true},{"selector": "@s","color":"green"}," 购买了 ",{"text":"装饰: 牛 B 的攻击","color":"green"}]
