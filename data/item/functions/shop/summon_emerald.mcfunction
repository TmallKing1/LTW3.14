# 给予绿宝石
summon item ~ ~ ~ {Item:{id:"emerald",Count:1b,tag:{stats_item:1b,display:{Lore:['{"text": "完成进度获得，可用于在装饰屋购买装饰粒子","color": "gray","italic": false}']}}},Tags:["score_item","new_stats"],PickupDelay:0}
