# 给予魔法精华
summon item ~ ~ ~ {Item: {id: "ghast_tear", Count: 1b, tag: {display: {Name: '{"text":"魔法精华","color":"light_purple","italic": false}'}, stats_item: 1b, Enchantments: [{id: "infinity", lvl: 1}], HideFlags: 1}}, Tags: ["score_item", "new_stats"], PickupDelay: 0}
