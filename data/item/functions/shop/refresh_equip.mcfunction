...
give @s[scores={shop_03_apple=1}] golden_apple{display: {Lore: ['{"text":"在部分小游戏中食用能使生命 +1","italic":false,"color":"gray"}'], Name: '{"text":"生命果","italic":false,"color":"aqua"}'}}
give @s[scores={shop_03_apple=2}] enchanted_golden_apple{display: {Name: '{"text":"附魔生命果","italic":false,"color":"light_purple"}', Lore: ['{"text":"在部分小游戏中食用能使当前生命加倍","italic":false,"color":"gray"}']}}
