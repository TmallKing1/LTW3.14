...
execute if score $color_match_time mem matches 2..8 if score $ley_line_disorder mem matches 1 run scoreboard players remove $color_match_time mem 1
...
execute unless score $ley_line_disorder mem matches 3 as @a[team=!debugging] run function mini:colormatch/game/show_floor_block