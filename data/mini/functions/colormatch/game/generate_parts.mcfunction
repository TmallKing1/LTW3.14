...
execute if score $floor_generate_part mem matches 9 unless score $ley_line_disorder mem matches 2 positioned 1000 10 4000 run setblock ~ ~ ~ minecraft:structure_block{posX:1,mode:"LOAD",name:"mini:color_match/color_9",integrity:0.01f}
execute if score $floor_generate_part mem matches 9 if score $ley_line_disorder mem matches 2 positioned 1000 10 4000 run setblock ~ ~ ~ minecraft:structure_block{posX:1,mode:"LOAD",name:"mini:color_match/color_9",integrity:0.03f}
