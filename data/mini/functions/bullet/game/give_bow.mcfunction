...
execute if score $ley_line_disorder mem matches -1 run item replace entity @s hotbar.8 with bow{game_item: 1b, powerful: 0b, display: {Name: '{"text":"弓","color":"aqua","italic":false}'}, Unbreakable: 1b}
