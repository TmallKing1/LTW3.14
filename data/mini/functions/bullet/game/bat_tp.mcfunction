...
execute as @e[type=silverfish,tag=bullet_entity] store success score $success mem if score @s villager_id = @e[tag=tagged_villager,limit=1] villager_id run tp @s ~ ~2 ~
