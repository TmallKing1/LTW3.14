...
execute if score $ley_line_disorder mem matches -1 run tellraw @s ["",{"text":"\n >> 子弹时间 >>  ","color":"dark_red","bold":true},{"text": "提出者：JK137  实现者：小猪之最Thepig","color": "aqua"},"\n\n 僵尸被替换为骷髅，被骷髅射中会 ",{"text": "损失随机数量的能量值","color": "gold"},"！\n 在下落到地面之前尽可能多地获取能量值吧！\n\n",{"text": " <无法攻击玩家> ","color":"green"},"\n "]