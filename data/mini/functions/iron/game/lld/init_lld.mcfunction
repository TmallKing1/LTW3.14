...
execute if score $lld_temp mem matches 3 run summon marker ~ ~ ~ {Tags: ["lld"], CustomName: '"丢三落四"', data: {length_title: 4, length_desc: 24, description: '"玩家受伤时会被动掉落一个铁锭（无铁锭时掉落粗铁）"'}}
