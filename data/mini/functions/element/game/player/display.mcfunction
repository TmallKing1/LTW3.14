...
# 显示展示实体
execute if score $element_type mem matches 3 run summon text_display ~ ~2.5 ~ {text:'{"text":"雷","color":"#9400D3"}',Tags:["p"], billboard: "center", brightness: {block: 15, sky: 15}, background: 0}
execute if score $element_type mem matches 4 run summon text_display ~ ~2.5 ~ {text:'{"text":"水","color":"#436EEE"}',Tags:["p"], billboard: "center", brightness: {block: 15, sky: 15}, background: 0}
execute if score $element_type mem matches 5 run summon text_display ~ ~2.5 ~ {text:'{"text":"火","color":"#EE5C42"}',Tags:["p"], billboard: "center", brightness: {block: 15, sky: 15}, background: 0}
execute if score $element_type mem matches 6 run summon text_display ~ ~2.5 ~ {text:'{"text":"冰","color":"#97FFFF"}',Tags:["p"], billboard: "center", brightness: {block: 15, sky: 15}, background: 0}
