...
execute if score $mini_type mem matches 203 run function mini:potion/game_end
...
# 根据轮次清空物品栏
execute if score $round mem matches 6 run clear @a[team=playing]
execute if score #gamemode mem matches 2 if score $round mem matches 1 run clear @a[team=playing]
...
# 经验值缓存
scoreboard players add @a[tag=mini_rank1] exp_temp 3
...
# 给予进度
execute if score $mini_type mem matches 2 if score 游戏已进行时间 layer matches 30.. unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={layer=4..}] only ltw:parkour/tnt2
execute if score $mini_type mem matches 2 if score 游戏已进行时间 layer matches 40.. unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,tag=!tntrun_adv_failed] only ltw:parkour/tnt4
...
execute if score $mini_type mem matches 7 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={mini_heart=2..}] only ltw:vs/seat1
execute if score $mini_type mem matches 7 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={mini_heart=4..}] only ltw:vs/seat3
execute if score $mini_type mem matches 7 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,tag=!seat_adv_failed] only ltw:vs/seat4
...
execute if score $mini_type mem matches 11 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={health_disp=10..}] only ltw:blood/boomer1
execute if score $mini_type mem matches 11 unless score #gamemode mem matches 2 if score $countdown mem matches 1.. run advancement grant @a[tag=mini_rank1] only ltw:blood/boomer2
execute if score $mini_type mem matches 11 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={health_disp=20..}] only ltw:blood/boomer3
execute if score $mini_type mem matches 11 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,x=2000,y=22,z=1000,dx=32,dy=16,dz=32] only ltw:blood/boomer4
...
execute if score $mini_type mem matches 13 unless score #gamemode mem matches 2 if score $current_turn mem matches 10.. run advancement grant @a[tag=mini_rank1] only ltw:vs/vase3
execute if score $mini_type mem matches 13 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,tag=!vase_regenerated] only ltw:vs/vase4
execute if score $mini_type mem matches 201 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={health_disp=8..}] only ltw:blood/ass1
execute if score $mini_type mem matches 201 unless score #gamemode mem matches 2 if score $countdown mem matches 1.. run advancement grant @a[tag=mini_rank1] only ltw:blood/ass2
execute if score $mini_type mem matches 201 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={health_disp=20..}] only ltw:blood/ass3
execute if score $mini_type mem matches 201 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={health_disp=20..,creeperUsed=..3}] only ltw:blood/ass4
execute if score $mini_type mem matches 202 unless score #gamemode mem matches 2 run advancement grant @a[tag=mini_rank1,scores={layer=3..}] only ltw:parkour/arrow2
execute if score $mini_type mem matches 202 unless score #gamemode mem matches 2 if score $countdown mem matches 1.. run advancement grant @a[tag=mini_rank1,scores={layer=3..}] only ltw:parkour/arrow3
execute if score $mini_type mem matches 202 unless score #gamemode mem matches 2 if score $countdown mem matches 0 if score 强制死亡持续时间 layer matches 40.. run advancement grant @a[tag=mini_rank1] only ltw:parkour/arrow4
execute if score $mini_type mem matches 203 run advancement grant @a[tag=mini_rank1,tag=!potion_adv_failed] only ltw:vs/potion2
execute if score $mini_type mem matches 203 if entity @a[tag=mini_rank2,scores={health_virt=..0}] run advancement grant @a[tag=mini_rank1] only ltw:vs/potion4
