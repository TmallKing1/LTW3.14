...
# 触发单个模块
execute if score $mini_type mem matches 0 run function mini:parkour_old/tick5
...
execute if score $mini_type mem matches 103 run function mini:diamond/tick5
execute if score $mini_type mem matches 104 run function mini:hopper/tick5
execute if score $mini_type mem matches 202 run function mini:arrow/tick5
execute if score $mini_type mem matches 302 run function mini:element/tick5
execute if score $mini_type mem matches 303 run function mini:power/tick5
