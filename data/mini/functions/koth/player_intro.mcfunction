...
execute if score $ley_line_disorder mem matches 3 run tellraw @s ["",{"text": " ▶ 幻境干扰: ","color": "#7B68EE"},{"text": "玩家成功命中其他玩家时，该玩家会损失少量能量值。\n "}]
execute if score $ley_line_disorder mem matches -1 run tellraw @s ["",{"text":"\n >> 山丘之王 >>  ","color":"dark_red","bold":true},{"text": "地图：Hex-Dragon  作者：小猪之最Thepig","color": "aqua"},"\n\n 保持在红色区域即可 ",{"text":"为击退鱼积累能量值","color":"gold"},"。\n 手持击退鱼按 ",{"keybind":"key.swapOffhand","color": "gold"}," 可以获得其中的能量值！\n 但若离开红色区域，就只能获得积累能量值的 1/5……\n\n",{"text": " <只能击退玩家> ","color":"yellow"},{"text": " <免疫击退效果在本轮无效>","color":"light_purple"},"\n "]