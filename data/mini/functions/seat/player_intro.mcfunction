...
execute if score $ley_line_disorder mem matches -1 run tellraw @s ["",{"text":"\n >> 矿车抢座 >>  ","color":"dark_red","bold":true},{"text": "作者：小猪之最Thepig","color": "aqua"},"\n\n ",{"text":"攻击矿车内玩家","color":"gold"}," 可将其踢下矿车或累积失衡值。\n 当玩家失衡值达到 100% 时，受到攻击 ",{"text": "必定会被踢下矿车","color": "gold"},"！\n\n",{"text": " <只能击退玩家> ","color":"yellow"},"\n "]
