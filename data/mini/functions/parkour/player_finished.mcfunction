...
execute if score #temp mem matches 1..60 run advancement grant @s only ltw:parkour/treasure1
execute if score #temp mem matches 1..40 run advancement grant @s only ltw:parkour/treasure2
execute if score #temp mem matches 1..30 run advancement grant @s only ltw:parkour/treasure3
execute if score #temp mem matches 1..25 run advancement grant @s only ltw:parkour/treasure4
