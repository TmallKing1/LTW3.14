...
# 150s：雷达提示
execute if score $countdown mem matches 150 run title @a subtitle {"text":"⚠ 玩家位置将在三十秒后暴露！ ⚠","color":"yellow"}
...
execute if score $countdown mem matches 120 run title @a subtitle {"text":"⚠ 玩家位置已显示！ ⚠","color":"red"}
