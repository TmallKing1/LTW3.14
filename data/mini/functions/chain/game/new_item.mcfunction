...
# 生成物资
execute unless score $double_reward mem matches 1 if score $random mem matches 0 positioned 999.0 30 17074.0 run function item:bonus_item/gameparty/auto/low
execute unless score $double_reward mem matches 1 if score $random mem matches 1 positioned 999.0 30 17022.0 run function item:bonus_item/gameparty/auto/low
execute if score $double_reward mem matches 1 positioned 999.0 30 17074.0 run function item:bonus_item/gameparty/auto/low
execute if score $double_reward mem matches 1 positioned 999.0 30 17022.0 run function item:bonus_item/gameparty/auto/low
