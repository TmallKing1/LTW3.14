...
tellraw @s ["",{"text":"\n >> 爆裂纷争 >>  ","color":"gold","bold":true},{"text": "作者：","color": "aqua"},{"text": "Roser7419","underlined": true,"color": "aqua","clickEvent": {"action": "open_url","value": "https://github.com/Roser7419/"},"hoverEvent": {"action": "show_text","contents": {"text": "点击查看其 GitHub 主页\n已获得使用授权。"}}},"\n\n 使用给予的炸药 ",{"text":"炸死对手, 破坏平台！","color":"gold"},"\n 也可以使用炸药来把敌人扔下去！\n\n",{"text": " <只能使用道具淘汰玩家> ","color":"yellow"},"\n "]
