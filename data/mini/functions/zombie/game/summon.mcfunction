...
execute if score $random mem matches 2 run item replace entity @e[tag=new_zombie,tag=normal_zombie] armor.head with player_head{SkullOwner: "Seayay"}
execute if score $random mem matches 3 run item replace entity @e[tag=new_zombie,tag=normal_zombie] armor.head with player_head{SkullOwner: "passerby_yin"}
...
execute if score $random mem matches 8 run item replace entity @e[tag=new_zombie,tag=normal_zombie] armor.head with player_head{SkullOwner: "JK137"}
...
execute if score $random mem matches 11 run item replace entity @e[tag=new_zombie,tag=normal_zombie] armor.head with player_head{SkullOwner: "Gumezm"}
...
data modify entity @e[tag=new_zombie,limit=1] Health set value 30.0f
## 1 阶段后的僵尸攻击伤害
...
## 3 阶段后的僵尸生命值
execute if score $zombie_stage mem matches 3.. run attribute @e[tag=new_zombie,limit=1] generic.max_health base set 50
execute if score $zombie_stage mem matches 3.. run data modify entity @e[tag=new_zombie,limit=1] Health set value 50.0f
