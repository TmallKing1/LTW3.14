...
execute as @a[tag=mini_running] unless entity @s[x=1988.0,y=-5.0,z=11988.0,dx=44,dy=27,dz=44] at @s run damage @s 11.4514 out_of_world
execute as @e[type=zombie] unless entity @s[x=1988.0,y=-5.0,z=11988.0,dx=44,dy=27,dz=44] at @s run kill

# 判断是否符合刷出新物品的条件：0 为可以，其他为不可以
scoreboard players set #new_item mem 0

# 当前场地上没有物品
execute if entity @e[tag=bonus_item,x=2000,y=0,z=12000,dx=100,dy=1000,dz=100] run scoreboard players set #new_item mem 1
