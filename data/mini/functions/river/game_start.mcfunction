...
# 生成可用于拿取物资的交互实体
summon interaction 1029.5 19 16028.5 {Tags: ["basic", "river_entity"], width: 0.9f, height: 0.9f, response: 1b}
summon interaction 1029.5 19 16018.5 {Tags: ["basic", "river_entity"], width: 0.9f, height: 0.9f, response: 1b}
summon interaction 1029.5 19 16013.5 {Tags: ["basic", "river_entity"], width: 0.9f, height: 0.9f, response: 1b}
summon interaction 1029.5 19 16003.5 {Tags: ["basic", "river_entity"], width: 0.9f, height: 0.9f, response: 1b}
...
# 生成初始物资
execute as @e[type=interaction,tag=river_entity,tag=basic] at @s run function mini:river/game/new_mats_single