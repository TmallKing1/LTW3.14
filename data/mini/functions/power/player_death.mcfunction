title @s times 10t 20t 10t
title @s subtitle ""
title @s title {"text": "你失败了！","color": "red"}
...
# 根据连杀次数决定死亡提示头
execute unless entity @a[tag=killer_player] run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"gray"},{"text":">> ","bold":true},"自杀"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 1 unless score @p[tag=dead_player] kill_streak matches 3.. run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#FFFF00"},{"text":">> ","bold":true},"击败"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 1 if score @p[tag=dead_player] kill_streak matches 3.. run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#FFFF00"},{"text":">> ","bold":true},"终结"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 2 run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#FFD700"},{"text":">> ","bold":true},"双杀"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 3 run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#FFB90F"},{"text":">> ","bold":true},"三杀"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 4 run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#FF8247"},{"text":">> ","bold":true},"四杀"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 5 run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#FF6A6A"},{"text":">> ","bold":true},"五杀"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 6 run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#EE2C2C"},{"text":">> ","bold":true},"六杀"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 7 run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#B03060"},{"text":">> ","bold":true},"七杀"]'
execute as @a[tag=killer_player] if score @s kill_streak matches 8.. run data modify storage mini:power deathmessage_header set value '[{"text":"","color":"#FF1493"},{"text":">> ","bold":true},"绝杀"]'

# 根据自身标签决定死亡信息
execute unless entity @a[tag=killer_player] as @p[tag=dead_player] run function mini:power/game/death_message_failure
execute if entity @a[tag=killer_player] as @p[tag=dead_player] run function mini:power/game/death_message_success

# 显示死亡信息
tellraw @a [{"nbt":"deathmessage_header","storage": "mini:power","interpret": true},{"text": "  "},{"nbt": "deathmessage","storage": "mini:power","interpret": true,"color": "white"}]
...
scoreboard players add @a[tag=killer_player] player_energy 50
scoreboard players set @a[scores={player_energy=101..}] player_energy 100

# 三杀提示
execute as @a[tag=killer_player] if score @s kill_streak matches 3 run tellraw @s [{"text":"","color":"red"},{"text":">> ","bold":true},"你的非充能伤害将减半！"]
execute as @a[tag=killer_player] if score @s kill_streak matches 3 run function mini:power/game/give_sword
...
function mini:power/game/give_sword

# 重生
function mini:power/game/respawn
